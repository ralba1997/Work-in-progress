...
for i in range(n):
    mytree.put(L[i], L[i], 1)

#                     VERIFY INSERTION
print()
print("VERIFY INSERTION")
print("size=", mytree.size, "   root=", mytree.root.key)
for i in range(n):
    num = L[i]
    print("L["+str(i)+"]="+str(num)+" in mytree?", num in mytree)
...
num = L[r]
print("elem=", num)
print("mytree[", num, "]=", mytree.get(num))

#                      GET MAX
print()
print("GET MAX")
print("findMax=", mytree.root.findMax().key)
...
print("mytree[", elem, "]=", mytree.get(elem))
mytree.delete(mytree.get(elem))
...
for i in range(n):
    elem = L[i]
    print("L["+str(i)+"]=" + str(elem) + " in mytree?", elem in mytree)
